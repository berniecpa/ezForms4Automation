...
class Html extends \yii\helpers\Html
{
    ...
    public static function uiWidgets()
    {
        return [
            ...
            // jSuites Input Mask
            UrlHelper::removeScheme(Url::to('@web/static_files/js/ui-widgets/jsuites.min.js', true))
            => Yii::t('app', 'jSuites') . ' (' . Yii::t('app', 'Allows you to add "data-mask" custom attributes to text fields, for example: data-mask="# ##0,00 €"', ['className' => '"krajee-star-rating"'])  . ')',
            // Krajee File Input
