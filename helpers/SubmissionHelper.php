...
class SubmissionHelper extends Component
{
     ...
     * @return array $data
     */
    public static function prepareDataForRuleEngine($submittedData, array $fields): array
    {
     ...
     */
    public static function prepareDataForReplacementToken(array $submissionData, array $fields): array
    {
        $data = array();
...
HTML;
     ...
     * @return string
     */
    public static function getSignatureImage($signature, $location, bool $html = true): string
    {
        $image = '';
        ...
        if (!empty($signature['dataURL'])) {
            $image = ImageHelper::storeBase64Image($signature['dataURL'], $location);
            if ($html) {
    ...
    public static function getFieldsForFieldMapping($fields = [], $addons = false)
    {
        ...
        $submissionHelper->fieldsForFieldMapping = array_merge($fields, [
            ...
            // Author
            'created_by' => Yii::t('app', 'Created By (User ID)'),
