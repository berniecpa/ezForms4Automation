 ...
 * group form components in multiple field sets with navigation links (Paginated Form).
 *
...
class Pager
{
     ...
     * Constructor.
     *
     * @param string|null $data Html of the form
     */
     ...
     * @return array List of Html code divided by the "page-break" tag.
     */
    public function getPreviousPages(int $to, int $from = 0): array
    {
    ...
    /**
     * @return string The form processed Html (with field sets and navigation links)
     */
    public function getPaginatedData(): string
    {
     ...
     * groups form components in field sets and add navigation links
     */
    ...
    /**
     * Build a navigation links list in html code, analyzing the "page break" tag data
     *
     * @param string $data Text of the form
     */
    protected function loadNavigationLinks(string $data)
    {
