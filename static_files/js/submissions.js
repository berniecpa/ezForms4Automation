...
App.Options = {
    ...
    showVirtualFields: 0,
    showDoiStatus: 0,
    showSenderInformation: 0,
    showAdditionalInformation: 0
};
...
App.DetailView = Backbone.View.extend({
    ...
    events: {
        ...
        'click #showVirtualFields' : 'showVirtualFields',
        'click #showDoiStatus' : 'showDoiStatus',
        'click #showSenderInformation' : 'showSenderInformation',
    ...
    showVirtualFields: function(e) {
        App.Options.showVirtualFields = $(e.currentTarget).is(':checked') ? 1 : 0;
        $.post(options.settingsEndPoint, { showVirtualFields: App.Options.showVirtualFields });
        this.render();
    },
    showDoiStatus: function(e) {
        App.Options.showDoiStatus = $(e.currentTarget).is(':checked') ? 1 : 0;
        $.post(options.settingsEndPoint, { showDoiStatus: App.Options.showDoiStatus });
        this.render();
    },
    showSenderInformation: function(e) {
        App.Options.showSenderInformation = $(e.currentTarget).is(':checked') ? 1 : 0;
        $.post(options.settingsEndPoint, { showSenderInformation: App.Options.showSenderInformation });
        this.render();
    },
    showAdditionalInformation: function(e) {
        App.Options.showAdditionalInformation = $(e.currentTarget).is(':checked') ? 1 : 0;
        $.post(options.settingsEndPoint, { showAdditionalInformation: App.Options.showAdditionalInformation });
        this.render();
    },
    ...
    render: function(){
        if (this.modelExists) {
            ...
            var showVirtualFields = App.Options.showVirtualFields ? 'checked' : '';
            var showDoiStatus = App.Options.showDoiStatus ? 'checked' : '';
            var showSenderInformation = App.Options.showSenderInformation ? 'checked' : '';
            var showAdditionalInformation = App.Options.showAdditionalInformation ? 'checked' : '';
            // Files
            var files = this.model.get("files"); // Submission Files
            // Comments
            var comments = this.model.get("comments"); // Submission Comments
            // Addons
            var addons = this.model.get("addons"); // Content provided by add-ons
            if (!_.isEmpty(files)) {
            ...
            this.el.innerHTML = this.template({
                ...
                showVirtualFields: showVirtualFields,
                showDoiStatus: showDoiStatus,
...
App.init = function(){
    ...
    App.Options.showVirtualFields = options.showVirtualFields;
    App.Options.showDoiStatus = options.showDoiStatus;
    App.Options.showSenderInformation = options.showSenderInformation;
    App.Options.showAdditionalInformation = options.showAdditionalInformation;
    // Server Data
