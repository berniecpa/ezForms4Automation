 ...
 *
 * Made by Baluart E.I.R.L., https://baluart.com
 * Based on Arjan Haverkamp, https://www.webgear.nl
...
(function($){
	...
	$.fn.fontselect = function(options) {
		...
		var settings = {
			...
			fontStyles: ':ital@0,1,wght@100,200,300,400,500,600,700,800,900'
		};
			...
			Fontselect.prototype = {
				...
				addFontLink: function(font) {
					...
					if (this.options.googleFonts.indexOf(font) > -1) {
						$('link:last').after('<link href="' + this.options.googleApi + font + this.options.fontStyles + '" rel="stylesheet" type="text/css">');
					}
