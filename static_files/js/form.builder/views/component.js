...
define([
    ...
    , "text!templates/app/pageBreak.html"
    ...
    return Backbone.View.extend({
        ...
        , initialize: function(){
            ...
            this.pageBreakTemplate = _.template(_pageBreak);
        ...
        , render: function(withAttributes, formSettings) {
            ...
            if (withAttributes) { // For canvas
                ...
                if (that.model.get("name") === "recaptcha") {
                    ...
                    return this;
                } else if (that.model.get("name") === "pagebreak") {
                    // If it is a pageBreak component return the html required
                    // To generate the correct pagination
                    this.htmlCode = that.pageBreakTemplate({field: fieldValues, layout: formSettings.layoutSelected});
                    return this;
                }
