            ...
            <div id="ses-settings" class="row" style="display: none">
                <div class="col-sm-12">
                    <div class="card mb-3">
                        <div class="card-status-start bg-blue"></div>
                        <div class="card-body">
                            <p><?= Yii::t('app', 'With Amazon SES you can send 3,000 messages per month at no charge.') ?></p>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group mb-3 required">
                        <?= Html::label(Yii::t('app', 'Admin e-mail'), 'app_adminEmail', ['class' => 'form-label has-star']) ?>
                        <?= Html::textInput('app_adminEmail', Yii::$app->settings->get('app.adminEmail'), ['class' => 'form-control', 'required' => true]) ?>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group mb-3 required">
                        <?= Html::label(Yii::t('app', 'Support e-mail'), 'app_supportEmail', ['class' => 'form-label has-star']) ?>
                        <?= Html::textInput('app_supportEmail', Yii::$app->settings->get('app.supportEmail'), ['class' => 'form-control', 'required' => true]) ?>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group mb-3 required">
                        <?= Html::label(Yii::t('app', 'No-Reply e-mail'), 'app_noreplyEmail', ['class' => 'form-label has-star']) ?>
