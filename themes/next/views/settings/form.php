                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-12" style="padding: 0;">
                        <ul>
                            ...
                            <li><small><?= Yii::t('app', 'Adds "Custom Attributes" option to Matrix fields before v2.2.1') ?></small></li>
                            <li><small><?= Yii::t('app', 'Adds "Prepend", "Append" and "Input Group CSS Class" options to File, Select List, Text Area and Text fields before v2.2.1') ?></small></li>
                        </ul>
