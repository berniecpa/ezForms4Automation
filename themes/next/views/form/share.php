    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-sm-3">
                <div class="card">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a id="sendEmail" href="#email" class="list-group-item list-group-item-action">
                            <span class="fal fa-envelope me-2"></span> <?= Yii::t('app', 'Send By Email') ?>
                        </a>
            ...
            <div class="col-sm-9">
                ...
                <div class="card" id="email" style="display: none">
                    <div class="card-header">
                        <h3 class="card-title">
                            <span class="me-2"><i class="fal fa-envelope"></i></span>
                            <?= Yii::t('app', 'Send Form By Email') ?>: <?= Html::encode($formModel->name) ?>
                        </h3>
                    </div>
                    <div class="card-body">
                        <p><?= Yii::t('app', 'Share a direct link to your form via email.') ?></p>
                        <?= $this->render('_sendByEmail', [
