...
$fields = SubmissionHelper::getFieldsForFieldMapping($fields, false);
$fieldsWithAddons = SubmissionHelper::getFieldsForFieldMapping($fields, true);
$fieldList = [];
$fieldListWithAddons = [];
...
foreach ($fieldsWithAddons as $name => $label) {
    $fieldListWithAddons[] = [
        "text" => $label,
        "value" => $name
    ];
...
if (!empty($formModel->ui->js_file)) {
    $jsFiles = (array) array_diff($formModel->ui->js_file, array_keys($uiWidgets));
...
$options = [
    ...
    "fieldListUrl" => Url::to(['ajax/fields']),
    'userListUrl' => Url::to(['/ajax/user-list']),
    ...
    "iHeight" => 250,
    "fieldList" => $fieldList,
    "fieldListWithAddons" => $fieldListWithAddons,
                                ...
                                [
                                    ...
                                    'attributes' => [
                                        ...
                                        'authorized_urls_error_type' => [
                                            ...
                                            'widgetClass'=>'\kartik\switchinput\SwitchInput',
                                            'columnOptions'=>['colspan'=>3],
                                            'hint'=> Yii::t('app', 'Hide form in unauthorized urls'),
                                            'options' => [
                                                'pluginEvents' => [
                                                    "switchChange.bootstrapSwitch" => "function(event, state) {
                                                        if (state) {
                                        ...
                                        'authorized_urls_error_message' => [
                                            'type'=>Form::INPUT_TEXT,
                                            'options'=>['placeholder'=>Yii::t('app', 'You are not authorized to access this form.')],
                                            'columnOptions'=>['colspan'=>3],
                                            'hint'=> Yii::t('app', 'Message displayed when the form is hidden.'),
                                        ],
                                        'password' => [
                                            'type'=>Form::INPUT_TEXT,
                                                ...
                                                <fieldset class="item">
                                                    <div class="card mb-3">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <?= $form->field($rule, "[{$i}]custom_html")->checkbox(['uncheck' => null, 'custom' => true]); ?>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                            ...
                                            <fieldset id="itemTemplate" class="d-none">
                                                <div class="card mb-3">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <?= $form->field($formConfirmationRuleModel, "custom_html")->checkbox(['uncheck' => null, 'custom' => true]); ?>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                ...
                                [
                                    'attributes' => [
                                        'mail_message' => [
                                            ...
                                            'options'=>[
                                                'data-editor' => (new Preferences($formModel))->get('formconfirmation-mail_message-editor'),
                                                'data-preferences-url' => Url::to(['/ajax/form-preferences', 'id' => $formModel->id]),
                                                'data-rich-editor-text' => Yii::t('app', 'Rich Editor'),
                                                'data-code-editor-text' => Yii::t('app', 'HTML Code'),
                                                'class' => 'placeholder-autocomplete',
                                                'rows' => 6,
                                    ...
                                    'attributes' => [
                                        'message' => [
                                            ...
                                            'hint'=> Html::tag('small', Yii::t('app', 'Allowed HTML Tags:') . ' '
                                                ...
                                                . Yii::t('app', 'Enter a curly bracket "{" to merge fields.')),
                                            'options'=>[
                                                'data-editor' => (new Preferences($formModel))->get('formemail-message-editor'),
                                                'data-preferences-url' => Url::to(['/ajax/form-preferences', 'id' => $formModel->id]),
                                                'data-rich-editor-text' => Yii::t('app', 'Rich Editor'),
                                                'data-code-editor-text' => Yii::t('app', 'HTML Code'),
                                                'class' => 'placeholder-autocomplete',
