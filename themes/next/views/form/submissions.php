...
$fields = $formDataModel->getFieldList([
    'type' => 'multidimensional',
    'form' => true, // Include form fields
    'alias' => true, // Add alias to field labels
]);
...
if (Yii::$app->user->can("updateFormSubmissions", ['model' => $formModel])) {
    $bulkActions .=
        '<a href="#" id="markAsRead" class="dropdown-item">'
        . IconHelper::show('folder-open', ['class' => 'dropdown-item-icon'])
        . Yii::t('app', 'Mark as Read')
        . '</a>'
        . '<a href="#" id="markAsUnread" class="dropdown-item">'
        . IconHelper::show('folder', ['class' => 'dropdown-item-icon'])
        . Yii::t('app', 'Mark as Unread')
        . '</a>';
}
if (Yii::$app->user->can("deleteFormSubmissions", ['model' => $formModel])) {
    $bulkActions .=
        '<a href="#" id="deleteSelectedRows" class="dropdown-item"><span class="text-red">'
        . IconHelper::show('trash', ['class' => 'me-2'])
        . Yii::t('app', 'Delete')
        . '</span></a>';
}
...
$options = array(
    ...
    'showVirtualFields' => Yii::$app->user->preferences->get('GridView.submissions.settings.showVirtualFields'), // User Preference
    'showDoiStatus' => Yii::$app->user->preferences->get('GridView.submissions.settings.showDoiStatus'), // User Preference
    'showSenderInformation' => Yii::$app->user->preferences->get('GridView.submissions.settings.showSenderInformation'), // User Preference
    'showAdditionalInformation' => Yii::$app->user->preferences->get('GridView.submissions.settings.showAdditionalInformation'), // User Preference
                                                    ...
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end showHideColumns" role="menu">
                                                            <li class="dropdown-item">
                                                                <label for="check_SubmissionId" class="form-check form-switch m-0 me-2">
                                                                    <input type="checkbox" id="check_SubmissionId" class="form-check-input column" data-key="index" value="2">
                                                            ...
                                                            <li class="dropdown-item">
                                                                <label for="check_SubmissionNumber" class="form-check form-switch m-0 me-2">
                                                                    <input type="checkbox" id="check_SubmissionNumber" class="form-check-input column" data-key="number" value="3">
                                                                    <span class="form-check-label">
                                                            ...
                                                            <li class="dropdown-item">
                                                                <label for="check_Column4" class="form-check form-switch m-0 me-2">
                                                                    <input type="checkbox" id="check_Column4" class="form-check-input column" data-key="id" value="4">
                                                                    <span class="form-check-label">
                                                            ...
                                                            <li class="dropdown-item">
                                                                <label for="check_Column5" class="form-check form-switch m-0 me-2">
                                                                    <input type="checkbox" id="check_Column5" class="form-check-input column" data-key="doi_status" value="5">
                                                                    <span class="form-check-label">
                                                            ...
                                                            <?php $i = 5; foreach ($fields as $field) : ?>
                                                                <?php ++$i ?>
                                                                <li class="dropdown-item">
                                                                    <label for="check_<?= $field['name'] ?>" class="form-check form-switch m-0 me-2">
                                                                        <input type="checkbox" id="check_<?= $field['name'] ?>" class="form-check-input column" data-key="<?= $field['name'] ?>" value="<?= $i ?>" checked="checked">
                                                                        <span class="form-check-label">
            ...
            <?php if (substr($field['name'], 0, 16) === "hidden_signature"): ?>
                <div data-key="<?= $field['name'] ?>" class="view table-cell">
                    {{ if(!_.isEmpty(data['<?= $field['name'] ?>'])) { }}
                        {{ var i = ''; try { var s = JSON.parse(data['<?= $field['name'] ?>']); var i = s['dataURL'] } catch {} }}
                        {{ if(!_.isEmpty(i)) { }}
                                    ...
                                    <tbody>
                                        <tr>
                                            <th colspan="2">
                                                <div class="float-end">
                                                    <div class="dropdown">
                                                        <a href="#" class="btn btn-icon btn-link" style="min-height: 20px; min-width: 20px" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                                                            <?= IconHelper::show('dots') ?>
                                                        </a>
                                                        <div class="dropdown-menu dropdown-menu-end" data-popper-placement="bottom-end">
                                                            <div class="dropdown-item">
                                                                <label for="showEmptyFields" class="form-check form-switch m-0 me-2">
                                                                    <input id="showEmptyFields" class="form-check-input" type="checkbox" {{= showEmptyFields }}>
                                                                    <span class="form-check-label">
                                                            ...
                                                            <div class="dropdown-item">
                                                                <label for="showDoiStatus" class="form-check form-switch m-0 me-2">
                                                                    <input id="showDoiStatus" class="form-check-input" type="checkbox" {{= showDoiStatus}}>
                                                                    <span class="form-check-label">
                                                                        <?= Yii::t('app', 'DOI Status') ?>
                                                                    </span>
                                                                </label>
                                                            ...
                                                            <div class="dropdown-item">
                                                                <label for="showSenderInformation" class="form-check form-switch m-0 me-2">
                                                                    <input id="showSenderInformation" class="form-check-input" type="checkbox" {{= showSenderInformation }}>
                                                                    <span class="form-check-label">
                                                            ...
                                                            <div class="dropdown-item">
                                                                <label for="showAdditionalInformation" class="form-check form-switch m-0 me-2">
                                                                    <input id="showAdditionalInformation" class="form-check-input" type="checkbox" {{= showAdditionalInformation }}>
                                                                    <span class="form-check-label">
                            ...
                            <?php if (Yii::$app->user->can("viewFormSubmissionComments", ["model" => $formModel])): ?>
                                <div class="col-sm-4">
                                    {{ if (addons && addons.length) { }}
                                        <div class="mb-3 addonBox">
                                            {{ _.each(addons, function(addon, idx) { }}
                                                {{ if (addon.hasOwnProperty('format') && addon.format === 'raw') { }}
                                                    {{= addon.content }}
                                                {{ } else { }}
                                                    <div class="card">
                                                        <div class="card-body" data-addon-id="">
                                                            {{= addon.content }}
                                                        </div>
                                                    </div>
                                                {{ } }}
