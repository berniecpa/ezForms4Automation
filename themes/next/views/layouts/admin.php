                    ...
                    <?= Menu::widget([
                        ...
                        'items' => [
                            ...
                            [
                                ...
                                'items' => [
                                    [
                                        'options' => ['tag' => 'a', 'class' => 'dropdown-item', 'href' => 'https://docs.easyforms.dev/', 'target' => '_blank'],
                                        'template' => '
                                    ...
                                    [
                                        'options' => ['tag' => 'a', 'class' => 'dropdown-item', 'href' => 'https://support.easyforms.dev/', 'target' => '_blank'],
                                        'template' => '
                                    ...
                                    [
                                        'options' => ['tag' => 'a', 'class' => 'dropdown-item text-pink', 'href' => 'https://www.youtube.com/@easyforms', 'target' => '_blank'],
                                        'template' => '
            ...
            <div class="container-xl">
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        ?>
                        <?php if (Yii::$app->user->can("configureSite")
                            || Yii::$app->user->can("configureMailServer")
                            || Yii::$app->user->can("migrateData")
                            || Yii::$app->user->can("accessPerformanceTools")
                            || Yii::$app->user->can("manageSite")) : ?>
                            <?php echo SideNav::widget([
                                'containerOptions' => [
                                    'class' => 'mb-3',
                                ],
