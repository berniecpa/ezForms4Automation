                ...
                if ($userModule) {
                    ...
                    if (isset($userModule->mailParams)) {
                        $userModule->mailParams = [
                            'fromEmail' => MailHelper::from($app->settings->get("supportEmail", "app", "")),
                            'welcomeMailSubject' => Yii::t('app', 'Welcome to {0}', $app->settings->get("name", "app", "")),
                            'confirmationMailSubject' => Yii::t('app', 'Confirm account on {0}', $app->settings->get("name", "app", "")),
                            'reconfirmationMailSubject' => Yii::t('app', 'Confirm email change on {0}', $app->settings->get("name", "app", "")),
                            'recoveryMailSubject' => Yii::t('app', 'Complete password reset on {0}', $app->settings->get("name", "app", "")),
                        ];
                    }
                }
